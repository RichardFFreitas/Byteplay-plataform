  ...
  useEffect(() => {
    const fetchUpdates = async () => {
      try {
        ...
        const formatted: Update[] = data.map((release: any) => {
          ...
          else if (/launch|release|v1.0/i.test(release.name))
            type = "announcement";
          ...
          return {
            ...
            description:
              release.body.split("\n")[0]?.replace(/^#+/, "").trim() ||
              "Veja os detalhes dessa atualização.",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Fique por dentro de todas as novidades, melhorias e correções da
            plataforma
          </p>
        </div>
          ...
          <Accordion type="single" collapsible className="w-full">
            {updates.map((update, index) => (
              <AccordionItem
                ...
                className="bg-gray-800/50 border-gray-700 rounded-lg overflow-hidden"
              >
                <AccordionTrigger className="px-6">
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <CardTitle className="text-white text-left text-xl truncate">
                        {update.title}
                      </CardTitle>
                    </div>
